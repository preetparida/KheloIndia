...
class Admin{
    ...
    public function insert(){
        ...
        $sql = "INSERT INTO LOGIN (USER_NAME,PASSWORD,ROLE) VALUES('".$this->username."','".$this->password."','".$this->type."')";
    ...
    public function retrive(){
       ...
       $sql = "SELECT * FROM `LOGIN` WHERE ROLE = '".SUPERSTOCKIST."' OR ROLE='".STOCKIST."' OR ROLE='".RETAILER."' OR ID = '".$_SESSION['ID']."'";
       $result = $database->run_this_query($sql);
       return $result;
    }
